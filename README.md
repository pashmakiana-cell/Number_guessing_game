...
👉 [Number Guessing Game](https://pashmakiana-numberguessinggame.streamlit.app)
...
2. Enter your guess.
3. If your guess is too high, try a lower number.
4. If your guess is too low, try a higher number.
5. Each incorrect guess reduces your score by 1 point.
6. Guess the correct number to win.
7. In the command-line version, enter `q` to quit.
